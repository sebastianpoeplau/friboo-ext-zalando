(ns org.zalando.stups.friboo.zalando-internal.system-test
  (:require [clojure.test :refer :all]
            ...
            [org.zalando.stups.friboo.zalando-internal.test-utils :as u]
        ...
        system        (component/map->SystemMap
                        {:http              (component/using
                                              (http/make-zalando-http
                                                "org/zalando/stups/friboo/zalando_internal/http.yaml"
                                                (:http configuration)
